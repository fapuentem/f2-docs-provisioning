...
#+BEGIN_SRC shell :results output replace :exports both :var L4T_DIR="~/nvidia/nvidia_sdk/JetPack_5.1.2_Linux_JETSON_ORIN_NX_TARGETS/Linux_for_Tegra/bootloader/t186ref/BCT/"
  set -euo pipefail
